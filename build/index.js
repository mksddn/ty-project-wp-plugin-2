...
function CustomMetaPanel() {
  const [typp_token] = (0,_wordpress_core_data__WEBPACK_IMPORTED_MODULE_3__.useEntityProp)("root", "site", "typp_token");
  const [playersOptions, setPlayersOptions] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)([]);
  const getPlayers = () => {
    fetch("https://ty.mailstone.net/api/players", {
      ...
      setPlayersOptions(data.filter(player => player.status == "active").map(player => ({
        label: player.name,
        value: player.id,
        type: player.type
      })));
  ...
  const updatePlayer = newValue => {
    setMeta({
      ...meta,
      typp_id: newValue,
      typp_name: playersOptions.filter(player => player.value == newValue)[0].label
    });
  };
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_edit_post__WEBPACK_IMPORTED_MODULE_4__.PluginDocumentSettingPanel, {
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("b", null, "Selected Player: ", (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", null, playerName))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("br", null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.SelectControl, {
    onClick: getPlayers,
    label: "Select a Static Player",
    value: playerID,
    options: titleOption.concat(playersOptions.filter(player => player.type == "static")),
    ...
    value: playerID,
    options: titleOption.concat(playersOptions.filter(player => player.type == "dynamic")),
    onChange: updatePlayer
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("br", null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.SelectControl, {
...
(0,_wordpress_plugins__WEBPACK_IMPORTED_MODULE_5__.registerPlugin)("typp-sidebar", {
